...
echo $('img').height(this.value*3); >>###BOOK.html 
...
for %%a in (*.jpg) do  Echo %%a | findstr /C:"LUT">nul && ( echo.TRUE    ) || (echo ^<img  src="%%a" height="25%%" title="%%~na" /^> >> ###BOOK.html)
